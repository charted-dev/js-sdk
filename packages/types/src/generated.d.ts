  ...
  "/users": {
    ...
    get: {
      responses: {
        200: {
          content: {
            "application/json": components["schemas"]["ApiResponseMainUserResponse"];
          };
        };
      };
    };
  ...
  "/users/{idOrName}/repositories/{repoIdOrName}": {
    ...
    get: {
      ...
      responses: {
        200: {
          content: {
            "application/json": components["schemas"]["ApiResponseListRepository"];
          };
        };
        /** @description If the authentication handler couldn't authorize successfully */
        401: {
  ...
  "/apikeys": {
    ...
    put: {
      responses: {
        201: {
          content: {
            "application/json": components["schemas"]["ApiResponseApiKeys"];
          };
        };
        /** @description If the authentication handler couldn't authorize successfully */
        401: {
  ...
  "/": {
    get: {
      responses: {
        200: {
          content: {
            "application/json": components["schemas"]["ApiResponseMainResponse"];
          };
        };
      };
    };
  ...
  "/repositories": {
    ...
    get: {
      responses: {
        200: {
          content: {
            "application/json": components["schemas"]["MainRepositoryResponse"];
          };
        };
      };
    };
...
export interface components {
  schemas: {
    ...
    } & components["schemas"]["ApiResponseListRepository"] & components["schemas"]["ApiResponseListString"] & components["schemas"]["ApiResponseApiKeys"] & components["schemas"]["ApiResponseMainUserResponse"] & components["schemas"]["ApiResponseMainResponse"], "errors" | "success">;
    FeaturesResponse: {
    ...
    } & components["schemas"]["ApiResponseListRepository"] & components["schemas"]["ApiResponseListString"] & components["schemas"]["ApiResponseApiKeys"] & components["schemas"]["ApiResponseMainUserResponse"] & components["schemas"]["ApiResponseMainResponse"], "success">;
    /** @description Represents a successful response, with any data attached if any */
    OkApiKeys: {
